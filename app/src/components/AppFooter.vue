<template>
  <v-footer height="180" app class="footer">
      <v-row no-gutters style="padding: 0px 40px">
        <v-col>
          <v-img 
            width="140"
            src="@/assets/american-airlines-logo.png"
            ></v-img>
        </v-col>
      <v-col>
        <v-card>
      ...
      <v-col>
        ...
        <h2>BKK</h2>
        <h3>11</h3>
        <v-card color="error" width="180">LATE DEPARTURE</v-card>
      </v-col>
      <v-col>
        <v-progress-linear
      color="white"
    ...
    ></v-progress-linear>
      ...
      <v-col>
        <h2>ARRIVAL: <br>NYC</h2>
        <v-card color="success"  width="180">ON TIME</v-card>
      </v-col>
    </v-row>
  </v-footer>
</template>
